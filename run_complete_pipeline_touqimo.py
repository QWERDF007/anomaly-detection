#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""End-to-End Multi-GPU Pipeline & Experimental Threshold Sweep for 透气膜 Dataset."""
...
def _worker_process(gpu_id, task_queue, result_queue):
    ...
    while True:
        ...
        # Run E2E Inference on full 468 images
...
def main():
    ...
    print(f"Launching {len(tasks)} tasks across 8 GPUs for 透气膜...")
