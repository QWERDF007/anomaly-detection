...
### 5.1 模型训练与建库耗时（含特征提取+降采样+建库完整流程）
| 输入尺寸 (Row) | Dinomaly2 深度训练 (Col 1) | PatchCore 全流程建库 (Col 2) | 二阶段特征库抽取 (Col 3) |
| :--- | :--- | :--- | :--- |
| 224 × 224 | 8.86 ~ 10.54 分钟 (532~633s) | 2.66 ~ 3.32 分钟 (159~200s) | ==7.3 ~ 8.8 秒== |
| 448 × 448 | 16.78 ~ 17.45 分钟 (1007~1047s) | 6.24 ~ 11.81 分钟 (N=400 OOM) | ==7.8 ~ 11.8 秒== |
| 672 × 672 | 22.17 ~ 23.65 分钟 (1330~1419s) | 35.6 ~ 38.5 分钟 (N>=200 OOM/降级) | ==9.5 ~ 49.0 秒== |
